...
Clear_button_xpath = "//*[@class="MuiButtonBase-root MuiButton-root MuiButton-contained MuiButton-containedSecondary"]"
Matches_xpath = "//*[@class="MuiListItemText-root jss35 jss214"]"
